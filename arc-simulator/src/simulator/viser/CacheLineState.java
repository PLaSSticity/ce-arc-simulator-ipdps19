...
class ViserLine extends VILine {
	...
	/**
	 * Viser needs to store values in addition to tags (unlike MESI). We do not need per-core
	 * values, since LLC values are globally visible.
	 */
	...
	public String toString() {
		String str = super.toString() + "\t" + this.state.toString() + "\tIdHash:"
				+ System.identityHashCode(this) + "\tCPU:" + id() + "\tLevel:" + level + "\tVer:"
				+ version + "\tLock owner:" + lockOwnerID + "\tAIM MD:" + hasAIMMD;
