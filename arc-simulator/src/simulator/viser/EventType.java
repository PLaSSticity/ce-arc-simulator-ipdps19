...
public enum EventType {
	...
	/** Insn counting */
	BASIC_BLOCK(11),
	LOCK_ACQUIRE(12), LOCK_RELEASE(13),
	THREAD_JOIN(14), THREAD_SPAWN(15), 
 IGNORE_CONFLICTS_BEGIN(
			16), IGNORE_CONFLICTS_END(17),
	ATOMIC_READ(18), ATOMIC_WRITE(19),
	...
	// Region boundary events
			...
			SERVER_ROI_START(25), SERVER_ROI_END(26);
