...
public enum EventType {
	...
	THREAD_BLOCKED(5),
	/** When a thread returns from blocking inside the kernel, e.g. after having joined */
	THREAD_UNBLOCKED(6), MEMORY_READ(7), MEMORY_WRITE(8), MEMORY_ALLOC(9), MEMORY_FREE(10),
	/** Insn counting */
	BASIC_BLOCK(11), LOCK_ACQUIRE(12), LOCK_RELEASE(13), THREAD_JOIN(14), THREAD_SPAWN(15),
	IGNORE_CONFLICTS_BEGIN(16), IGNORE_CONFLICTS_END(17), ATOMIC_READ(18), ATOMIC_WRITE(19),
